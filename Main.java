    ...
    public class Main {
        public static void main(String[] args) {
            ...
            for (int i = 0; i < 4; i++) {
                deckOfCards.setOpponent(deckOfCards.dealOpponent(1));
            }
            ...
            for (int i = 4; i < 12; i++) {
                ...
                if (i % 2 == 0) {
                    ...
                    } else if (deckOfCards.dealUser(1)[num_choice - 1].getFace().equals("J")) {
                        for (int j = 0; j < i + 1; j++) {
                            boards.accumulated_cards_user[j] = boards.board(num_choice, random_num)[j];
                        }
                        System.out.println("Cards on board:");
            ...
            for (int i = 12; i < 20; i++) {
                ...
                if (i % 2 == 0) {
                    if (deckOfCards.dealUser(2)[num_choice - 1].getFace().equals(boards.board(num_choice, random_num)[0].getFace())) {
                        ...
                        System.out.println("Cards on board:");
                        System.out.println(boards.board[i + 1]);
                    } else if (deckOfCards.dealUser(2)[num_choice - 1].getFace().equals("J")) {
                        for (int j = 12; j < i + 1; j++) {
                            boards.accumulated_cards_user[j] = boards.board(num_choice, random_num)[j];
                        }
                        System.out.println("Cards on board:");
            ...
            for (int i = 20; i < 28; i++) {
                ...
                if (i % 2 == 0) {
                    ...
                    } else if (deckOfCards.dealUser(3)[num_choice - 1].getFace().equals("J")) {
                        for (int j = 20; j < i + 1; j++) {
                            boards.accumulated_cards_user[j] = boards.board(num_choice, random_num)[j];
                        }
                        System.out.println("Cards on board:");
            ...
            for (int i = 28; i < 36; i++) {
                ...
                if (i % 2 == 0) {
                    ...
                    } else if (deckOfCards.dealUser(4)[num_choice - 1].getFace().equals("J")) {
                        for (int j = 28; j < i + 1; j++) {
                            boards.accumulated_cards_user[j] = boards.board(num_choice, random_num)[j];
                        }
                        System.out.println("Cards on board:");
            ...
            for (int i = 36; i < 44; i++) {
                ...
                if (i % 2 == 0) {
                    ...
                    } else if (deckOfCards.dealUser(5)[num_choice - 1].getFace().equals("J")) {
                        for (int j = 36; j < i + 1; j++) {
                            boards.accumulated_cards_user[j] = boards.board(num_choice, random_num)[j];
                        }
                        System.out.println("Cards on board:");
            ...
            for (int i = 44; i < 52; i++) {
                ...
                if (i % 2 == 0) {
                    ...
                    } else if (deckOfCards.dealUser(6)[num_choice - 1].getFace().equals("J")) {
                        for (int j = 44; j < i + 1; j++) {
                            boards.accumulated_cards_user[j] = boards.board(num_choice, random_num)[j];
                        }
                        System.out.println("Cards on board:");
